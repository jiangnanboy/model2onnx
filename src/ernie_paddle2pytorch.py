...
if __name__ == '__main__':
    extract_and_convert('../model/paddle_ernie', '../model/ernie_pytorch')
    tokenizer = BertTokenizer.from_pretrained('../model/ernie_pytorch')
    model = BertModel.from_pretrained('../model/ernie_pytorch')
    print(tokenizer.encode("你好", add_special_tokens=True))
    input_ids = torch.tensor([tokenizer.encode("你好", add_special_tokens=True)])
    with torch.no_grad():
